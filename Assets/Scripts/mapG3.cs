...
public class mapG3 : MonoBehaviour
{
            ...
            if (isHazard == true)
            {
                ...
                if (Random.value < bridgeChance)
                {
                    ...
                    if (Random.value < coinChance)
                    {
                        ...
                        GetComponent<ObjectP3>().PlaceCoin(new Vector2(blockNum, blockHeight), Mathf.RoundToInt(Random.Range(1, platformSize - startTile)), startTile);
                    }
                    ...
                    if (platformSize >= 3)
                    {
                        ...
                        {
                            GetComponent<EnemyPlacement3>().PlaceEnemy(new Vector2(blockNum + 1, blockHeight));
                    ...
                    for (int tiles = 0; tiles < platformSize; tiles++)
                    {
                        ...
                        if (tiles > 0 && tiles < platformSize - 1)
                        {
                            ...
                            {
                                GetComponent<ObjectP3>().PlaceObject(new Vector2(blockNum, blockHeight), isEnemyPlatform);
                            }
                        }
